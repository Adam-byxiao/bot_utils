...
def PinkDetection(image, edge_mask):
...
def main(filename):
    ...
    purple_mask1, image_marked1, purple_ratio1 = PinkDetection(image_rgb1, mask1)
    ...
    purple_mask2, image_marked2, purple_ratio2 = PinkDetection(image_rgb2, mask2)
